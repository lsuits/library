...
/**
 * Structure step to restore one library activity
 */
class restore_library_activity_structure_step extends restore_activity_structure_step {
    ...
    protected function after_execute() {
        // Add library related files, no need to match by itemname (just internally handled context)
